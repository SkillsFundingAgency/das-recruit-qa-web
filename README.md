...
dotnet run
```
* Open second command prompt and change directory to _**/src/Recruit.Qa.Web/**_
* Start the **Website**:
...
dotnet run
```
* Browse to `https://localhost:5025/dashboard`
...
* Open the solution _**/src/Recruit.Qa.sln**_
